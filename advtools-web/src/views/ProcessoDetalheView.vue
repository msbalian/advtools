           ...
           <template v-else>
              ...
              <div class="flex gap-2 p-1 bg-slate-200/50 rounded-2xl w-fit">
                 <button v-for="tab in tabs" 
                         ...
                         :class="[activeTab === tab.id ? 'bg-white text-primary-700 shadow-md font-black' : 'text-slate-500 hover:text-slate-800 font-bold', 'px-6 py-2.5 rounded-xl text-xs transition-all flex items-center gap-2']">
